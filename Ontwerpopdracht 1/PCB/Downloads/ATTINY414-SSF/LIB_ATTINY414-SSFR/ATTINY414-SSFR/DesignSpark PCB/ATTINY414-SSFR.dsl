...
(library Library_1
	...
	(compDef "ATTINY414-SSFR" (originalName "ATTINY414-SSFR") (compHeader (numPins 14) (numParts 1) (refDesPrefix IC)
		...
		(compPin "6" (pinName "TOSC1/PB3") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "7" (pinName "TOSC2/PB2") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "14" (pinName "GND") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "10" (pinName "PA0/__RESET__/UPDI") (partNum 1) (symPinNum 12) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://componentsearchengine.com/Datasheets/2/ATTINY414-SSFR.pdf")
		(attr "Height" "1.75 mm")
	)
